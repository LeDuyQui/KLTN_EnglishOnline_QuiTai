...
mongoose.connect(
  "mongodb://localhost:27017/onlineTest",
...
var questionRouterApi = require('./app/RouterAPI/questionRouterApi');
...
app.use("/api/onlinetest", accountRouterApi);
app.use("/api/onlinetest", staffRouterApi);
app.use("/api/onlinetest", customerRouterApi);
app.use("/api/onlinetest", questionRouterApi);